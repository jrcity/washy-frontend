...
import { Bell, Check, CheckCheck, Mail, Clock, Truck } from 'lucide-react';
            ...
            <div className="space-y-3">
                {notifications.length === 0 ? (
                    <Card variant="bordered" className="py-12">
                        <EmptyState
                            icon={<Truck className="w-12 h-12 text-neutral-300" />}
                            title={filter === 'unread' ? 'No unread notifications' : 'No notifications yet'}
                            description="New delivery assignments and updates will appear here"
                        />
                    </Card>
                ) : (
