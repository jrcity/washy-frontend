...
export const RiderDashboard = () => {
  ...
  const myAssignments = orders.filter(
    o => o.pickupRider === user?._id || o.deliveryRider === user?._id
  );

  const pickups = myAssignments.filter(o => o.status === 'confirmed' && o.pickupRider === user?._id);
  const deliveries = myAssignments.filter(o => o.status === 'out_for_delivery' && o.deliveryRider === user?._id);
