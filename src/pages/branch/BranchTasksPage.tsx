    ...
    return (
        <div className="max-w-7xl mx-auto space-y-10">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                <div>
                    <h1 className="text-3xl md:text-4xl font-black text-primary-900 tracking-tight leading-none mb-2">Dispatch Control</h1>
                    <div className="flex items-center gap-3 md:gap-4">
                        <p className="text-primary-500 font-bold uppercase tracking-widest text-[9px] md:text-[10px]">Strategic Logistics Matrix</p>
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    <Button
                        ...
                        className="rounded-2xl h-12 w-12 p-0 border-primary-100 bg-white shrink-0"
                        isLoading={refreshing}
                    >
                        {!refreshing && <RefreshCw className="w-5 h-5 text-primary-600" />}
                    </Button>
                    <Button
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <Card className="p-4 rounded-[20px] md:rounded-[24px] bg-primary-900 text-white border-none shadow-lg">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                            <p className="text-[8px] md:text-[9px] font-black text-primary-600 uppercase tracking-widest truncate">Active Ops</p>
                            <p className="text-lg md:text-xl font-black italic">{activeMissions}</p>
                        </div>
                    </div>
                </Card>
                <Card className="p-4 rounded-[20px] md:rounded-[24px] border-primary-100 bg-white shadow-sm">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                            <p className="text-[8px] md:text-[9px] font-black text-primary-400 uppercase tracking-widest truncate">Awaiting Rider</p>
                            <p className="text-lg md:text-xl font-black text-primary-900">{pendingDispatch}</p>
                        </div>
                    </div>
                </Card>
                <div className="col-span-2 flex items-center gap-1.5 md:gap-2 bg-primary-50 p-1.5 md:p-2 rounded-[24px] md:rounded-[28px] border border-primary-100 overflow-x-auto no-scrollbar">
                    {['all', 'pending', 'assigned', 'in_progress', 'completed'].map((f) => (
                        <button
                            ...
                            className={cn(
                                ...
                                filter === f ? "bg-white text-primary-600 shadow-sm" : "text-primary-400 hover:text-primary-600"
                            )}
                        >
                            {f.replace('_', ' ')}
                        </button>
                ...
                <AnimatePresence mode="popLayout">
                    {loading ? (
                        ...
                        >
                            ...
                            <p className="text-sm font-black text-primary-400 uppercase tracking-[0.2em] animate-pulse">Scanning Logistics Grid...</p>
                        </motion.div>
                        ...
                        >
                            <Card className="py-24 rounded-[48px] border-primary-100 border-dashed border-2 text-center shadow-inner bg-primary-50/30">
                                <div className="w-24 h-24 bg-white rounded-[40px] shadow-sm flex items-center justify-center mx-auto mb-8 border border-primary-50">
                                    <ClipboardList className="w-12 h-12 text-primary-200" />
                                </div>
                                <h3 className="text-2xl font-black text-primary-900 mb-2">Operational Zero</h3>
                                <p className="text-primary-400 font-bold uppercase tracking-widest text-[10px]">Currently no active missions matching your filter</p>
                                <div className="mt-8 flex justify-center">
                                    <Button variant="outline" className="rounded-2xl font-black border-primary-200" onClick={() => setIsCreateModalOpen(true)}>
                                        Initiate Protocol
                                    </Button>
                                </div>
                            </Card>
                        ...
                        filteredTasks.map((task, i) => (
                            <motion.div
                                ...
                                key={task._id}
                            >
                                <Card className="p-5 md:p-8 rounded-[32px] md:rounded-[40px] border-primary-100 hover:border-primary-200 hover:shadow-[0_20px_50px_rgba(14,165,233,0.08)] transition-all group overflow-hidden relative">
                                    ...
                                    <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6 md:gap-8 text-primary-900">
                                            ...
                                            <div className="space-y-2 md:space-y-4 min-w-0">
                                                ...
                                                <div className="flex flex-col sm:flex-row sm:items-center gap-2 md:gap-6">
                                                    <div className="flex items-center gap-2">
                                                        <div className="p-1 bg-primary-50 rounded-lg"><MapPin className="w-3 h-3 text-primary-400" /></div>
                                                        <span className="text-[10px] md:text-xs font-black text-primary-500 uppercase tracking-tighter truncate">{task.address.area} • {task.address.city}</span>
                                                    </div>
                                                    <div className="flex items-center gap-2 sm:border-l sm:border-primary-100 sm:pl-4 md:pl-6">
                                                        <div className="p-1 bg-primary-50 rounded-lg"><Clock className="w-3 h-3 text-primary-400" /></div>
                                        ...
                                        {/* Deployment Status */}
                                        <div className="flex items-center sm:justify-between lg:justify-end gap-4 md:gap-8 lg:border-l lg:border-primary-50 lg:pl-10">
                                            <div className="flex flex-col items-start lg:items-end min-w-[100px] md:min-w-[140px]">
                                                <p className="text-[8px] md:text-[9px] font-black text-primary-400 uppercase tracking-widest mb-1 md:mb-2">Tactical Assignee</p>
                                                {task.assignedTo ? (
                                            ...
                                            <div className="flex flex-col items-center px-4 md:px-8 border-x border-primary-50 min-w-[100px] md:min-w-[120px]">
                                                <p className="text-[8px] md:text-[9px] font-black text-primary-400 uppercase tracking-widest mb-1 md:mb-2">Mission Phase</p>
                                                <Badge
                                                    variant={
