  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        {selectedBranch && (
          <Card variant="bordered" className="p-4 md:col-span-2">
            <h4 className="text-sm font-medium text-neutral-500 mb-1">Processing Branch</h4>
            <div className="flex items-center gap-3">
              <div className="p-2 bg-primary-50 text-primary-600 rounded-lg">
                <MapPin className="w-4 h-4" />
              </div>
              <div>
                <p className="font-medium text-neutral-900">{selectedBranch.name}</p>
                <p className="text-xs text-neutral-500">{selectedBranch.address.street}, {selectedBranch.address.city}</p>
              </div>
            </div>
          </Card>
        )}
